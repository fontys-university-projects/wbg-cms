    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
            ...
            <ul class="flex justify-center items-center space-x-4 text-gray-500 dark:text-gray-400">
                <li>
                    <a @click="$router.back()" class="underline hover:text-gray-900 dark:hover:text-white">Go back</a>
                </li>
                <li>
                    <router-link to="/" class="underline hover:text-gray-900 dark:hover:text-white">Homepage</router-link>
                </li>
            </ul>
        </div>   
    </div>
